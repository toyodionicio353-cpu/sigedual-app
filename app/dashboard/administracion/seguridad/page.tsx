  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl">
      ...
      <p style={{ color: "var(--text-secondary)" }} className="text-sm mb-8">
        Controla qué correos pueden crear una cuenta de Profesor Supervisor o Coordinador en tu
        institución, y comparte el código de verificación con quienes deban registrarse.
        Estudiantes y Centros Duales se identifican directamente por su ficha registrada — no
        necesitan este código.
      </p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div style={{ background: "var(--bg-card)", border: "1px solid var(--border)" }} className="rounded-2xl p-5 sm:p-6">
            ...
            <p style={{ color: "var(--text-secondary)" }} className="text-sm mb-4">
              Solo los correos con este dominio podrán crear una cuenta de Profesor Supervisor o Coordinador.
            </p>
