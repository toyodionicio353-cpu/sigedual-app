...
/** Bloque de "Agregar centro dual" para invitar a una empresa a completar
 * su propio registro: un botón que genera un enlace válido por 24 horas
 * (sin pantalla ni formulario previo), y debajo la bandeja de formularios
 * ya recibidos con la acción "Autocompletar" hacia el detalle donde se
 * revisa la respuesta y se vuelca a centros_duales/maestros_guia. */
    ...
    <div style={{ borderTop: "1px solid var(--border)" }} className="mt-8 pt-8">
      <div className="mb-4">
        ...
        <p style={{ color: "var(--text-secondary)" }} className="text-sm mt-1">
          Genera un enlace único para que el Centro Dual complete su información y la de sus Maestros Guía, sin necesitar una cuenta. Es válido por {HORAS_EXPIRACION} horas.
        </p>
      </div>
