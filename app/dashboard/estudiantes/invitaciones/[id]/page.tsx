...
import {
  ArrowLeft, BadgeCheck, Phone, GraduationCap, HeartPulse, Users, Sparkles, ClipboardCheck, CheckCircle2, AlertTriangle, Wand2,
} from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-8 max-w-3xl">
      <div className="mb-6 flex items-start justify-between gap-3">
        ...
        <button
          onClick={() => setMostrarFormEstudiante(true)}
        ...
        >
          <Wand2 size={16} /> Autorrellenar Estudiante
        </button>
      </div>
